...
$(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '歌曲名', name: 'song', index: 'articleTitle', width: 80},
            {label: '歌曲url', name: 'songurl', index: 'songurl', width: 80},
            {label: '时长', name: 'duration ', index: 'duration', width: 80},
            {label: '热度', name: 'hot', index: 'hot', width: 80},
            {label: '图片', name: 'path', index: 'path', sortable: false, width: 100, formatter: imgFormatter},
